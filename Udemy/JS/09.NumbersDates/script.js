...
// use NaN only to check for the value is NaN 
console.log(Number.isNaN(20));
console.log(Number.isNaN('20'));
console.log(Number.isNaN(+'20x'));
console.log(Number.isNaN(23 / 0));

// Checking the value is a number
...
console.log(Math.max(1, 2, 44, 12, 32));
console.log(Math.min(5, 2, -5, -44));
...
console.log(Math.trunc(53.23));

console.log(Math.ceil(53.23));
console.log(Math.ceil(53.63));

console.log(Math.floor(53.13));
console.log(Math.floor(53.63));
...
const future = new Date(2034, 9, 21, 15, 23);
...
const pizzaTime = setTimeout((ing1, ing2) => console.log(`Here is your pizza with ${ing1} and ${ing2}`), 3000, ...ingredients);
